...
const Card = React.memo(({ isAboutSectionVisible, animationName, animationDelay, img, role, name, bio } : any) => {
  ...
  return (
    <div className={`${isAboutSectionVisible ? "animate__animated " + animationName : ""} relative w-96 shadow-2xl border-8 rounded-[10%] p-5 bg-slate-300`} style={{ animationDelay }}>
      ...
      <h4 className="text-center font-black text-[#003366] underline">{name}</h4>
